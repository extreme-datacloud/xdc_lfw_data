...
def metadata_gen(title, dateIni, dateEnd,
    ...
    # ----beginDate
    ET.SubElement(
        ET.SubElement(rangeOfDates, "beginDate"),
        "calendarDate").text = dateIni
    # ---endDate
    ET.SubElement(
        ET.SubElement(rangeOfDates, "endDate"),
...
def metadata_gen(title, dateIni,
    ...
    eml = ET.Element(
        "{eml://ecoinformatics.org/eml-2.1.1}eml", system="knb")
    ...
    ET.SubElement(
        ET.SubElement(
            rangeOfDates, "beginDate"), "calendarDate").text = dateIni
    # ---endDate
    ET.SubElement(
        ET.SubElement(rangeOfDates, "endDate"), "calendarDate").text = dateEnd
...
def file_block_csv(title, params, parent):
    ...
    ET.SubElement(
        ET.SubElement(textFormat, "simpleDelimited"),
        "fieldDelimiter").text = "\\t"
